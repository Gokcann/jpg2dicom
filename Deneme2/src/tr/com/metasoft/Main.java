...
//            pathSub[0] = pathSub[0] + ".dcm";
            File myOutputFile = new File("\\directoryhere");
//            File f = new File(file.getAbsolutePath());
//            new Jpgdcm(f,myOutputFile);
        new Jpgdcm(null,null).modifyTag();
...
//        //command[0] = "storescu";
//        command[0] = "-c";
//        command[1] = "DCM4CHEE@192.168.12.44:11112";
//        command[2] = "D:\\a\\a\\asd7.dcm";
...
//        command4[7] = "aa.xml";
        ...
        //Process process = new Process("C:\\Program Files\\Weasis\\Weasis.exe");
        //process.getInputStream("-w http://192.168.12.44:8080/dcm4chee-arc/aets/DCM4CHEE/rs/studies/2.25.136291433045103039131152633540194462488/metadata");
